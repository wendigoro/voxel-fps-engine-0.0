...
public final class MaterialPalette {
    ...
    public static final class Entry {
        ...
        public Entry(int id, String name, int rgb) {
            this.id = id; this.name = name; this.rgb = rgb & 0xFFFFFF;
        }
    }
    ...
    public static float density(int id) {
        return switch (id) {
            case WOOD -> 0.70f; case CONCRETE -> 2.40f; case DIRT -> 1.20f;
    ...
    public static float weightMul(int id) {
        return switch (id) {
            case WOOD -> 1.00f; case CONCRETE -> 1.35f; case DIRT -> 1.10f;
